...
/**
 * ElasticSlider adapted from React Bits.
 * Removed Chakra UI and react-icons dependencies for project consistency.
 * Added onChange prop to support parent state updates.
 */
